...
modbus_registers[64]=(char)(UBMAX/256);			//Рег33
modbus_registers[65]=(char)(UBMAX%256);
...
modbus_registers[63]=(char)((UB20-DU)%256);
modbus_registers[64]=(char)(UBMAX/256);					//Рег33  Напряжение содержания батареи при 0гЦ, 0.1В
modbus_registers[65]=(char)(UBMAX%256);
