...
if(RXBUFF[0]==PUT_LB_TM1)
	...
	lakb[temp]._max_cell_volt=(unsigned short)(*((unsigned short*)&RXBUFF[2]));
	lakb[temp]._min_cell_volt=(unsigned short)(*((unsigned short*)&RXBUFF[4]));
	lakb[temp]._tot_bat_volt=(unsigned short)(*((unsigned short*)&RXBUFF[6]));
	lakb[temp]._cnt=0;
     }
if(RXBUFF[0]==PUT_LB_TM2)
	...
	lakb[temp]._ch_curr=(unsigned short)(*((unsigned short*)&RXBUFF[2]));
	lakb[temp]._dsch_curr=(unsigned short)(*((unsigned short*)&RXBUFF[4]));
	lakb[temp]._rat_cap=(unsigned short)(*((unsigned short*)&RXBUFF[6]));
...
if(RXBUFF[0]==PUT_LB_TM3)
	...
	lakb[temp]._s_o_h=(unsigned short)RXBUFF[2];
	lakb[temp]._s_o_c=(unsigned short)RXBUFF[3];
	lakb[temp]._c_c_l_v=(unsigned short)(*((unsigned short*)&RXBUFF[4]));
	lakb[temp]._r_b_t=(unsigned short)RXBUFF[6];
	lakb[temp]._flags1=(unsigned short)RXBUFF[7];
...
if(RXBUFF[0]==PUT_LB_TM4)
	...
	lakb[temp]._bRS485ERR=(unsigned short)RXBUFF[2];
	lakb[temp]._rs485_cnt=(unsigned short)RXBUFF[3];
	lakb[temp]._max_cell_temp=(unsigned short)RXBUFF[4];
	lakb[temp]._min_cell_temp=(unsigned short)RXBUFF[5];
	lakb[temp]._flags2=(unsigned short)RXBUFF[6];
