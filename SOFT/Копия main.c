...
//	int2lcdyx(plazma_can_inv[0],0,5,0);
//	int2lcdyx(plazma_can_inv[1],0,9,0);
//	int2lcdyx(plazma_can_inv[2],0,13,0); 
	//int2lcdyx(bCAN_INV,0,19,0);
